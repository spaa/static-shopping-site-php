...
<?php include'login.inc.php'; ?>
    ...
    <section id="form_before_launch">
   	...
   	<p onclick="animate()" id="on">login</p>
   	<form id="form" method="post" action="login.php">
   		<div>
   			...
   			<div>
   			<input type="text" id="username" name="username" placeholder="Username or Email_id" required="" />
   			...
   			<span style="position: absolute;right: 10px;font-family: arial;font-size: 12px;vertical-align: bottom;">Not a member : <a href="../php/register.php"> Register</a></span>
   ...
   <div style="position: absolute;left: 37%; top: 170px;margin: 0px auto;background: #ffdddd;width: auto;height: auto;">
   <!--url-->
   <?php
   
   
   if(strpos($url, 'error=failed') !== false){
   	echo "<div style='color: #a94442;
	background-color: #f2dede;
    border-left: 6px solid #f44336;
    padding: 10px;position:absolute;margin:0px auto;width: 350px'> WRONG USERNAME/PASSWORD COMBINATION</div>";
   } 
   ?>
   <!-- error specifier-->
   ...
   <div style="position: absolute;top: 600px;z-index: -1;width: 100%">
<div class="foot">
