...
<img id="zoom_01" src='../images/small/MOB1.jpg' data-zoom-image="../images/large/MOB1.jpg"/>
<div id="gal1">
 
  <a href="#" data-image="../images/small/MOB1.jpg" data-zoom-image="../images/large/MOB1.jpg">
    <img id="img_01" src="../images/thumb/MOB1.jpg" />
  </a>

  <a href="#" data-image="../images/small/MOB2.jpg" data-zoom-image="../images/large/MOB2.jpg">
    <img id="img_01" src="../images/thumb/MOB2.jpg" />
  </a>

  <a href="#" data-image="../images/small/MOB3.jpg" data-zoom-image="../images/large/MOB3.jpg">
    <img id="img_01" src="../images/thumb/MOB3.jpg" />
  </a>

  <a href="#" data-image="../images/small/MOB4.jpg" data-zoom-image="../images/large/MOB4.jpg">
    <img id="img_01" src="../images/thumb/MOB4.jpg" />
  </a>
...
<div style="position: absolute;right: 10px;top: 200px;width: 800px;line-height: 35px;">
 <div style="padding-top: 8px;color: #212121;font-size: 18px;font-weight: 400;">  Moto G5 Plus (Lunar Grey, 32 GB)  (4 GB RAM) 
 <br><span style="color: #878787;">Ratings &nbsp;&nbsp;</span><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star-half" style="color: #ffe11b;"></i>
 </div>
 ...
 <div>
  <span class="fa fa-tag" style="color: #388e3c;font-size: 20px;font-weight: bolder;"></span> Special Price Flat ₹2,000 Off On Moto G5 Plus <span style="color: #2874f0;font-weight: bolder;">T & C</span>
 </div>
 <div>
...
<div style="position: absolute;right: 10px;top: 500px;width: 800px;display: flex;">
  ...
  <div style="flex: 3;color: #212121;"> <ul><li>4 GB RAM | 32 GB ROM | Expandable Upto 128 GB</li>
<li>5.2 inch Full HD Display</li>
<li>12MP Rear Camera | 5MP Front Camera</li>
<li>3000 mAh Battery</li>
<li>Qualcomm Snapdragon 625 Octa Core 2GHz Processor</li></ul></div>
</div>
...
<div style="position: absolute;right: 10px;top: 620px;width: 800px;display: flex;">
  ...
  <div style="flex: 3;color: #212121;"> <ul><li>EMI starting from ₹728/month</li>
...
<div style="position: absolute;right: 10px;top: 720px;width: 800px;display: flex;">
  ...
  <div style="flex: 3;color: #212121;"> Meet the Moto G5 Plus - the smartphone that boasts of performance and power. Powered by a 2.0 GHz octa-core Qualcomm Snapdragon 625 processor and 3000 mAh battery, along with TurboPower technology, this Moto mobile offers a glitch-free performance all day long.</div>
</div>
