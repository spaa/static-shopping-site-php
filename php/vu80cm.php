...
<img id="zoom_01" src='../images/small/vu-32.jpg' data-zoom-image="../images/large/vu-32.jpg"/>
<div id="gal1">
 
  <a href="#" data-image="../images/small/vu-32.jpg" data-zoom-image="../images/large/vu-32.jpg">
    <img id="img_01" src="../images/thumb/vu-32.jpg" />
  </a>

  <a href="#" data-image="../images/small/vu-32d.jpg" data-zoom-image="../images/large/vu-32d.jpg">
    <img id="img_01" src="../images/thumb/vu-32d.jpg" />
  </a>

  <a href="#" data-image="../images/small/vu-32d2.jpg" data-zoom-image="../images/large/vu-32d2.jpg">
    <img id="img_01" src="../images/thumb/vu-32d2.jpg" />
  </a>

  <a href="#" data-image="../images/small/vu-32d7.jpg" data-zoom-image="../images/large/vu-32d7.jpg">
    <img id="img_01" src="../images/thumb/vu-32d7.jpg" />
  </a>
...
<div style="position: absolute;right: 10px;top: 200px;width: 800px;line-height: 35px;">
 ...
 <br><span style="color: #878787;">Ratings &nbsp;&nbsp;</span><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i><i class="fa fa-star" style="color: #ffe11b;"></i>
 </div>
 <div><span class="fa fa-rupee" style="font-size: 30px;color: #388e3c;"></span><span style="font-size: 30px;color: #388e3c;">13,999</span> &nbsp;&nbsp; <span class="fa fa-rupee" style="font-size: 18px;text-decoration: line-through;vertical-align: middle;"></span><i style="font-size: 18px;text-decoration: line-through;vertical-align: middle;">13,999</i> &nbsp;&nbsp;<b style="color: #388e3c;font-size: 20px;font-weight: bolder;">17% &nbsp;&nbsp; off</b></div>
 <div>
  <span class="fa fa-calendar-o" style="color: #388e3c;font-size: 20px;font-weight: bolder;"></span> EMIs from ₹728/month <span style="color: #2874f0;font-weight: bolder;">View Plans</span>
 </div>
 <div>
  <span class="fa fa-tag" style="color: #388e3c;font-size: 20px;font-weight: bolder;"></span>Try Phone Checkup- Get up to 12% more on exchange! (Applicable only on Flipkart App)<span style="color: #2874f0;font-weight: bolder;"></span>
 </div>
 <div>
  <span class="fa fa-tag" style="color: #388e3c;font-size: 20px;font-weight: bolder;"></span> Special PriceFlat ₹2,000 Off On Moto G5 Plus <span style="color: #2874f0;font-weight: bolder;">T & C</span>
 </div>
 <div>
  <span class="fa fa-tag" style="color: #388e3c;font-size: 20px;font-weight: bolder;"></span> Bank OfferExtra 5% off* on Axis Bank Buzz Credit Cards <span style="color: #2874f0;font-weight: bolder;">T & C</span>
 </div>
 </div>
</div >
...
<div style="position: absolute;right: 10px;top: 500px;width: 800px;display: flex;">
  <div style="flex: 1;color: #878787;">Highlights </div>
  <div style="flex: 3;color: #212121;"> <ul><li>8 + 8 W Speaker Output : For good-quality TV sound</li>
<li>1280 x 720 HD Ready - Great picture quality</li>
<li>60 Hz : Standard refresh rate for blur-free picture quality</li>
<li>2 x HDMI : For set top box and consoles</li>
<li>2 x USB : Easily connect your digital camera, camcorder or USB device</li></ul></div>
</div>
...
<div style="position: absolute;right: 10px;top: 620px;width: 800px;display: flex;">
  ...
  <div style="flex: 3;color: #212121;"> <ul><li>EMI starting from ₹679/month</li>
...
<div style="position: absolute;right: 10px;top: 720px;width: 800px;display: flex;">
  <div style="flex: 1;color: #878787;">Description </div>
  <div style="flex: 3;color: #212121;"> Awesome Viewing from All Angles<br>
Is there a single spot in your living room that everyone fights for as it offers the best viewing angle for your TV? Well, you can say goodbye to that fight, thanks to the 178-degree viewing angle of this TV. Now, you can get an enjoyable experience from almost anywhere in the room.</div>
</div>
